...
public class WheelMain {
	...
	public void initDateTimePicker(int year, int month, int day, int h, int m) {
		...
		if (hasSelectTime) {
			...
			wv_day.setVisibility(View.GONE);// TODO 加上此句，代表只显示 年 月
		}
	...
	public String getYearMonthDay() {
		...
		sb.append(year).append("-").append(parseDate(month)).append("-").append(parseDate(day));
//		
//		sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-")
//				.append((wv_month.getCurrentItem() + 1)).append("-")
//				.append((wv_day.getCurrentItem() + 1));
	...
	public String getHourMinute() {
		...
		String min= String.valueOf(wv_mins.getCurrentItem());		
		sb.append(parseDate(hour)).append(":").append(parseDate(min));
		return sb.toString();
	}
