 ...
 * 
 */
public class FunIntroductionActivity extends BaseActivity implements OnClickListener{
	/**
	 * 公共顶部布局
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fun_introduction);
		viewInit();
	}
	...
	private void viewInit() {
		...
		topView.setTitleTextViewText("功能介绍");
