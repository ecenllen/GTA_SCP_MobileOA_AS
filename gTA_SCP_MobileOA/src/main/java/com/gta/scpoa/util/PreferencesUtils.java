...
public class PreferencesUtils {
	...
	public static Map<String,Object> getAll(Context context){
		...
		SharedPreferences settings = context.getSharedPreferences(
				PREFERENCE_NAME, Context.MODE_PRIVATE);
		map = (Map<String, Object>) settings.getAll();
		return map;
	}
	/**
	...
	public static boolean getFirstRun(Context context, String modelName) {

		SharedPreferences sharedPreferences = context.getSharedPreferences(
				"share", context.MODE_PRIVATE);
		boolean isFirstRun = sharedPreferences.getBoolean(modelName, true);
		Editor editor = sharedPreferences.edit();
		if (isFirstRun) {
			editor.putBoolean(modelName, false);
			editor.commit();
			return false;
		} else {
			return true;
