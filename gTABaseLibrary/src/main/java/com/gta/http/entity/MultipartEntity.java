...
public class MultipartEntity implements HttpEntity {
	 ...
	 *            {@link MIME#DEFAULT_CHARSET} - i.e. UTF-8 - is used.
	 */
	public MultipartEntity(HttpMultipartMode mode, String boundary,
		...
		this.multipart = new HttpMultipart(multipartSubtype, this.charset,
				this.boundary, mode);
		this.contentType = new BasicHeader(HTTP.CONTENT_TYPE,
	...
	protected String generateContentType(final String boundary,
